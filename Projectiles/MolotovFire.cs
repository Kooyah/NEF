...
{
    public class MolotovFire : ModProjectile
    {
        public override void SetStaticDefaults()
	    {
		    DisplayName.SetDefault("Molotov Fire");
	    }
	...
	public override void SetDefaults()
        ...
        {                                                    
            projectile.rotation = (float)Math.Atan2((double)projectile.velocity.Y, (double)projectile.velocity.X) + 1.01f;  
	...
	public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		...
		target.AddBuff(BuffID.OnFire, 50, true);
    	}	
    }
}